...
class type_customer extends StatefulWidget {
  const type_customer({super.key});

  @override
  State<type_customer> createState() => _type_customerState();
}

class _type_customerState extends State<type_customer> {
  @override
          ...
          children: [
            ...
            Expanded(
              child: Container(
                ...
                child: Center(
                  child: Text(
                    (systems.get_all()[0].language == "thai" ? thai_text().customer_discount : eng_text().customer_discount) + " ",
                    style: GoogleFonts.sarabun(
                      textStyle: Theme.of(context).textTheme.displayLarge,
                      fontSize: 25,
                      fontWeight: FontWeight.w300,
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      update_discount_customer(context, index);
                    },
                    onDoubleTap: () {
                      delect_discount_customer(context, index);
                    },
                    child: Container(
                              ...
                              child: Row(children: [
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        customers.get_discount_customer()[index].discount.toStringAsFixed(2) + "%",
                                        style: GoogleFonts.sarabun(
                                          textStyle: Theme.of(context).textTheme.displayLarge,
                                          fontSize: 25,
                                          fontWeight: FontWeight.w300,
